...
class Species {
    ...
    public void readInput() {
        ...
        System.out.println("Enter Area of The city:");
    ...
    public double getDensity(int year) {
        return predictPopulation(year) / area;
    }
...
class Tester6 {
    ...
    public static void main(String[] args) {
        ...
        ob.readInput();
        int c = 0;
        while (ob.getDensity(c) <= 1) {
            ++c;
        }
        System.out.println("Total " + c + " Years Needed");
    }
}
